...
import uk.aston.placestest.NearbyParks.Parser;
...
public class WeatherActivity extends AppCompatActivity {
    ...
    public void getWeather(View v)
    {
        ...
        //Call<Example> examplecall=myapi.getTemperature(googlePlaceJSON.getJSONObject("geometry").getJSONObject("location").getString("lat"), googlePlaceJSON.getJSONObject("geometry").getJSONObject("location").getString("lng"),apikey);
